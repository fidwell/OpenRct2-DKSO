...
$outnames = "fidwell.v1.scenery_group.trees_dkso",
            ...
            "fidwell.v1.scenery_group.creepy_dkso",
            "fidwell.v1.scenery_group.jungle_dkso",
            "fidwell.v1.scenery_group.jurassic_dkso",
            "fidwell.v1.scenery_group.martian_dkso",
